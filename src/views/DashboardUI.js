      ...
      <div class='dashboard-content'>
        <div class='bills-feed'>
          <div class='status-bills-header'>
            <h3> En attente(s) : ${filteredBills(data && data.bills, "pending").length} </h3>
          ...
          <div class='status-bills-container' id='status-bills-container1'>
            ...
            <div class='status-bills-header' style='margin-top: 20px;'>
              <h3> Validé(s) : ${filteredBills(data && data.bills, "accepted").length} </h3>
            ...
            <div class='status-bills-header' style='margin-top: 20px;'>
              <h3> Refusé(s) : ${filteredBills(data && data.bills, "refused").length} </h3>
